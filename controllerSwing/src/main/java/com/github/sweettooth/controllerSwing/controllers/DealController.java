...
public class DealController implements IDealController {
	...
	public DealController(GameNavigator gameNavigator, WindowNavigator windowNavigator, IGameSession sessionData, IGameRound gameData) {
